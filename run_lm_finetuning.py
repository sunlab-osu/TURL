...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    eval_dataset = WikiTableDataset(args.data_dir, src="dev", max_length = [50, 10, 10], force_new=False, tokenizer=tokenizer)
...
def main():
    ...
    if args.do_train:
        ...
        train_dataset = WikiTableDataset(args.data_dir, src="train", max_length = [50, 10, 10], force_new=False, tokenizer=tokenizer)
